...
public class ResidentialBuilding implements Rescuable, Simulatable 
{
	...
	public String toString() {
		String m ="-----------------AZTEC--------------"+"\n";
		m+= "Location: "+ this.location.toString()+"\n";
		m+= "StructuralIntegrity: "+this.structuralIntegrity+"\n";
		m+="FireDamage: "+ this.fireDamage+"\n";
		m+= "GasLevel: "+ this.gasLevel+"\n";
		m+="FoundationDamage: "+this.foundationDamage+"\n";
		m+="Number of Occupnts: "+ (this.occupants).size()+"\n";
